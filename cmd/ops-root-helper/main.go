...
func main() {
	...
	service := &roothelper.Service{AgentUID: uint32(*agentUID), ApproverUID: uint32(*approverUID), Store: store, Audit: log, Executor: executor, RollbackTimeout: *rollbackTimeout}
