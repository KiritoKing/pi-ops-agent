...
required_paths=(
  ...
  "${REPOSITORY_ROOT}/config/agentd.json"
  "${REPOSITORY_ROOT}/config/models.json"
  "${REPOSITORY_ROOT}/systemd/agentd-approval-reviewer.service"
  "${REPOSITORY_ROOT}/systemd/agentd-approval-reviewer.service.d/zzzz-ops-agent-security.conf"
  "${REPOSITORY_ROOT}/systemd/agentd-client-gateway.service"
  "${REPOSITORY_ROOT}/systemd/agentd-client-gateway.service.d/zzzz-ops-agent-security.conf"
  "${REPOSITORY_ROOT}/systemd/agentd-plugin-lease-broker.service"
  "${REPOSITORY_ROOT}/systemd/agentd-plugin-lease-broker.service.d/zzzz-ops-agent-security.conf"
  "${REPOSITORY_ROOT}/systemd/agentd-guardian.service"
  "${REPOSITORY_ROOT}/systemd/agentd-guardian.service.d/zzzz-ops-agent-security.conf"
  "${REPOSITORY_ROOT}/systemd/ops-agentd.service"
  "${REPOSITORY_ROOT}/systemd/ops-agentd.service.d/zzzz-ops-agent-security.conf"
  "${REPOSITORY_ROOT}/systemd/ops-agent-server.service"
  "${REPOSITORY_ROOT}/systemd/ops-agent-server.service.d/zzzz-ops-agent-security.conf"
  "${REPOSITORY_ROOT}/systemd/ops-root-helper.service"
  "${REPOSITORY_ROOT}/systemd/ops-root-helper.service.d/zzzz-ops-agent-security.conf"
  "${REPOSITORY_ROOT}/systemd/ops-agent-healthcheck.service"
  "${REPOSITORY_ROOT}/systemd/ops-agent-healthcheck.service.d/zzzz-ops-agent-security.conf"
  "${REPOSITORY_ROOT}/systemd/ops-agent-healthcheck.timer"
  "${REPOSITORY_ROOT}/systemd/ops-agent.target"
  "${REPOSITORY_ROOT}/systemd/ops-agent.tmpfiles.conf"
  "${REPOSITORY_ROOT}/systemd/ops-agent-endpoint.tmpfiles.conf"
  "${REPOSITORY_ROOT}/systemd/ops-pve-root-helper.service"
  "${REPOSITORY_ROOT}/systemd/ops-pve-root-helper.service.d/zzzz-ops-agent-security.conf"
